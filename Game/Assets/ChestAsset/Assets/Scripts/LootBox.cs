...
public class LootBox : MonoBehaviour
{
    ...
    public void Open ()
    {
        ...
        {
            // Создайте копию объекта из префаба
            GameObject spawnedLoot = Instantiate(lootObject, transform.position, Quaternion.identity);
            // Поместите копию объекта на место сундука
            spawnedLoot.transform.SetParent(transform.parent); // Если сундук и его содержимое должны быть на одном уровне иерархии
            // spawnedLoot.transform.position = transform.position; // Или просто установите позицию объекта равной позиции сундука
        }
